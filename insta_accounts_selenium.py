...
if __name__ == '__main__':
    account = InstaAccountSelenium('login','password')
    account.login()
    account.wait_verification_upload()
    account.upload_image(r"D:\Download\testefotoreal.jpeg")
    account.image_data('Isto é um teste! Por favor, não interaja!')
    account.share()
